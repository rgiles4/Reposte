...
#     # #B=11 => + 11 = 111 (It’s “valid” math, though not typical scoreboard data)
...
#     # Example from doc: 0x0A => binary 1010 => D1=1 => 2 matches, D3=1 => left priority
#     b7 = 0x0A  # 0b1010
...
#     # Another example: 0x07 => 0b0111 => D1=0, D0=3 => 3 matches, D2=1 => right priority, D3=0 => left priority off
#     # Actually note that D0..D1 can only form 0..3 in decimal, so bits are 2 bits total. If D0=1, D1=1 => that’s 3
#     b7 = 0x07  # 0b0111 => D0=1, D1=1 => 3 matches, D2=1 => right priority, D3=0 => left priority
#     result = parse_matches_and_priorities(b7)
...
#     # Another scenario: 0x0F => 00001111 => bits D0..D3 are all 1 => all four penalty lights ON
#     b9 = 0x0F
#     result = parse_penalty_bits(b9)
...
#     # Another scenario: 0x05 => 00000101 => bits D0=1 => Right Red ON, D2=1 => Right Yellow ON
#     b9 = 0x05
#     result = parse_penalty_bits(b9)
#     assert result["penalty_right_red"] is True
#     assert result["penalty_left_red"] is False
