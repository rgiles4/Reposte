...
class VideoRecorder:
    def __init__(
        ...
        self.replay_update_callback: Optional[Callable[[QPixmap], None]] = (
            None
        )
    ...
    def start_in_app_replay(
        ...
        self.replay_update_callback = (
            update_callback or self.live_update_callback
        )
    ...
    def show_next_frame(self):
        ...
        self.replay_index = min(
            self.replay_index + 1, len(self.replay_buffer.get_all()) - 1
        )
