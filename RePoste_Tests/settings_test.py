...
def test_settings_window_display(create_app):
    ...
    assert settings_window.isHidden(), (
        "❌ Settings window should be hidden on initialization.")

    settings_window.show()
    assert settings_window.isVisible(), (
        "❌ Settings window did not become visible after calling show().")

    settings_window.close()
    assert settings_window.isHidden(), (
        "❌ Settings window did not close properly.")
